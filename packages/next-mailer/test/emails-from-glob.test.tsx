...
describe(emailsFromGlob, () => {
  ...
  test("should report and error for invalid imports", async () => {
    ...
    expect(consoleSpy).toHaveBeenNthCalledWith(
      1,
      "Next-Mailer: ./__mocks/email-invalid-default.js does not contain a default export or the default export is not a component.",
    );
    expect(consoleSpy).toHaveBeenNthCalledWith(
      2,
      "Next-Mailer: ./__mocks/email-no-default.js does not contain a default export or the default export is not a component.",
    );
  });
});

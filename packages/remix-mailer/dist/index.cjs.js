...
__export(src_exports, {
  ...
  PreviewBrowserNav: () => PreviewBrowserNav,
  PreviewBrowserNavItem: () => PreviewBrowserNavItem,
...
var usePreviews = () => {
  const { [RM_DATA_KEY]: previews } = (0, import_react.useLoaderData)();
  return previews;
};
...
var ScrollArea = React2.forwardRef(({ className, children, ...props }, ref) =>
  /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(ScrollAreaPrimitive.Root, {
    ref,
    ...
    children: [
      /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
        ...
        { className: "h-full w-full rounded-[inherit]", children },
      ),
...
var SheetOverlay = React3.forwardRef(({ className, ...props }, ref) =>
  /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(SheetPrimitive.Overlay, {
    className: cn(
...
var SheetTitle = React3.forwardRef(({ className, ...props }, ref) =>
  /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(SheetPrimitive.Title, {
    ref,
...
var SheetDescription = React3.forwardRef(({ className, ...props }, ref) =>
  /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(SheetPrimitive.Description, {
    ref,
...
var TabsList = React4.forwardRef(({ className, ...props }, ref) =>
  /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(TabsPrimitive.List, {
    ref,
    className: cn(
...
var TabsTrigger = React4.forwardRef(({ className, ...props }, ref) =>
  /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(TabsPrimitive.Trigger, {
    ref,
    className: cn(
...
var TabsContent = React4.forwardRef(({ className, ...props }, ref) =>
  /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(TabsPrimitive.Content, {
    ref,
    className: cn(
...
var PreviewBrowser = import_react3.default.forwardRef(
  ({ className, ...props }, ref) => {
    var _a;
    const [searchParams, setSearchParams] = (0,
    import_react2.useSearchParams)();
    ...
    const nav = /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(
      PreviewBrowserNav,
      {
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("div", {
      ...
      children: [
        ...
        /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("div", {
          ...
          children: [
            /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)(Sheet, {
              children: [
                /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(SheetTrigger, {
                  asChild: true,
                  children: /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(
                    Button,
                    {
                      ...
                      children: /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(
                        import_react_icons2.HamburgerMenuIcon,
                        {},
                      ),
                    },
                  ),
                }),
                /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(SheetContent, {
                  side: "left",
            ...
            /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(Tabs, {
              value: view,
              ...
              children: /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)(
                TabsList,
                {
                  ...
                  children: [
                    /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(TabsTrigger, {
                      value: "desktop",
                      children: "Desktop",
                    }),
                    /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(TabsTrigger, {
        ...
        selected
          ? /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)(Tabs, {
              value: view,
              children: [
                /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(
                  import_react_tabs.TabsContent,
                  {
                    value: "desktop",
...
var PreviewBrowserNav = import_react3.default.forwardRef(
  ({ children, ...rest }, ref) => {
    return /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("div", {
      ref,
      ...rest,
      children: [
        /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("div", {
          className:
            "px-6 border-b border-dotted flex gap-1.5 items-center h-14",
          children: [
            /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(Logo, {}),
        ...
        /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)(ScrollArea, {
          children: [
...
var PreviewBrowserNavItem = import_react3.default.forwardRef(
  ({ onClick, value, children, isSelected, className, ...rest }, ref) => {
    const onClickWithValue = import_react3.default.useCallback(
      (e) => {
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)(Button, {
      ...
      children: [
        /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(
          import_react_icons2.ComponentPlaceholderIcon,
